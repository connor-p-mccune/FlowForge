...
Everything above is covered by tests: **181 server suites (2669 tests)**, 67
client files (662), 338 CLI tests, and 84 pytest tests for the AI service — lint
