...
const COMMANDS = {
  ...
  mutants: require('../src/commands/mutants'),
  ...
  explain: require('../src/commands/explain'),
...
Usage:
  ...
  flowforge explain <execution-id> [--node <id>]   Why this run did what it did — the decision that closed each path, and the values it read
